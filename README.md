...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/jenish-chauhan/End-to-End-k8s-DevSecOps-Tetirs-Project.git
   ```
...
# End-to-End-k8s-DevSecOps-Tetirs-Project

> > > > > > > 6cc8b6e45007a0c06de4a4e4d0f059fa8af83d68
